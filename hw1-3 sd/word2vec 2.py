...
def main():
    ...
    #Training section
    start_time = time.time()
    emb,_ = word2vec_trainer(input_set, target_set, len(w2i), codedict, freqtable, frequency, use_subsampling=True, threshold=0.001, mode=mode, NS=ns, dimension=64, epoch=1, learning_rate=0.01)
    end_time = time.time()
    time_elapsed = end_time - start_time
